...
- When implementing features or analyzing support issues involving Disk Arbitration, consult [Apple's open-source DiskArbitration implementation](https://github.com/apple-oss-distributions/DiskArbitration/) for additional context, while accounting for possible differences from the macOS version being investigated.
